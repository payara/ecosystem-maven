...
### Latest version available: 1.5.0-SNAPSHOT
...
- __payaraVersion__ (optional |  default: 5.2021.5): By default ```bundle``` mojo fetches payara-micro with version 5.2021.5.
...
- __payaraVersion__ (optional | default: "5.2021.5"): The payara-micro version that will be used with ```start``` mojo.

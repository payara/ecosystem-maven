 ...
 * <ul>
 *  <li>Fetch payara-micro from repository and open it to a folder. The default version is <i>6.2023.1</i>. Specific
...
public class BundleMojo extends BasePayaraMojo {
    ...
    /**
     * By default this mojo fetches payara-micro with version 6.2023.1. It can be overridden with this parameter.
     */
